...
class CarouselInline {
  ...
  public static function the_BS4_carousel($attachments) {
    ...
    $output = "<div id='gallery-{$post->post_name}' class='carousel slide inline720px bg-inverse'><div class='carousel-inner' role='listbox'>";

    $output .= '<ol class="carousel-indicators">';
    $photo_number = 0;
    foreach ( $attachments as $key => $value ) {
        $output .= "<li data-target='#gallery-{$post->post_name}' data-slide-to='{$photo_number}'></li>";
        $photo_number ++;
    }
    $output .= '</ol>';
    ...
    $output .= "</div>";
    $output .= "<a class='carousel-control-prev' href='#gallery-{$post->post_name}' role='button' data-slide='prev'> <span class='fa fa-2x fa-chevron-left' aria-hidden='true'></span> <span class='sr-only'>Previous</span> </a> <a class='carousel-control-next' href='#gallery-{$post->post_name}' role='button' data-slide='next'> <span class='fa fa-2x fa-chevron-right' aria-hidden='true'></span> <span class='sr-only'>Next</span></a>";
    $output .= "</div>";
